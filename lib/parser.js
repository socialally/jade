...
Parser.prototype = {
  ...
  parseInclude: function(){
    ...
    var block = 'indent' == this.peek().type ? this.block() : null;
    var include = new nodes.Include(tok.val.trim(), tok.filter, tok.attrs && tok.attrs.attrs, block);
    this.dependencies.push(include);
    return include;
  },
